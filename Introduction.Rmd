---
title: "Introduction to flexdashboard and shiny"
author: "Yuezhu Xu, Zhengyi Fang"
date: "2021/10/25"
...
![](arrange1.png){width=40%} ![](arrange2.png){width=40%}

![](arrange_out1.png){width=40%} ![](arrange_out2.png){width=40%}
...
![](Categorical_Input.png){height=300px}
...
![](Numerical_Input.png){height=150px}
...
![](Ex1Input.png){height=200px} ![](Ex1CodeInput.png){width=65%}
...
![](Ex1Graph1.png){height=360px}![](Ex1Graph2.png){height=360px}
...
![](Ex2Input1.png){height=150px}![](Ex2Input2.png){height=150px}

![](Ex2CodeInput.png){width=60%}
...
![](Ex2Graph1.png){height=360px}![](Ex2Graph2.png){height=360px}
...
![](Ex3CodeInput.png){height=480px} ![](Ex3Input.jpg){height=480px}  
...
![](Ex3InputSelected.jpg){height=400px}  ![](Ex3Graph.png){width=700px height=350px}
